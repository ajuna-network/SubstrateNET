...
namespace SubstrateNET.RestClient.Test.Generated
{
   ...
   public class RankedPollsControllerClientTest : ClientTestBase
   {
      ...
      public SubstrateNET.NetApi.Generated.Model.SpRuntime.BoundedVecT44 GetTestValue16()
      {
         SubstrateNET.NetApi.Generated.Model.SpRuntime.BoundedVecT44 result;
         result = new SubstrateNET.NetApi.Generated.Model.SpRuntime.BoundedVecT44();
      ...
      public async System.Threading.Tasks.Task TestTrackQueue()
      {
         ...
         // Construct new RPC client to test with.
         RankedPollsControllerClient rpcClient = new RankedPollsControllerClient(_httpClient, subscriptionClient);
         SubstrateNET.NetApi.Generated.Model.SpRuntime.BoundedVecT44 mockupValue = this.GetTestValue16();
         ...
         SubstrateNET.NetApi.Generated.Model.SpRuntime.BoundedVecT44 rpcResult = await rpcClient.GetTrackQueue(mockupKey);
