...
namespace SubstrateNET.RestClient.Test.Generated
{
   ...
   public class AuthorityDiscoveryControllerClientTest : ClientTestBase
   {
      ...
      public SubstrateNET.NetApi.Generated.Model.sp_core.bounded.weak_bounded_vec.WeakBoundedVecT8 GetTestValue2()
      {
         SubstrateNET.NetApi.Generated.Model.sp_core.bounded.weak_bounded_vec.WeakBoundedVecT8 result;
         result = new SubstrateNET.NetApi.Generated.Model.sp_core.bounded.weak_bounded_vec.WeakBoundedVecT8();
      ...
      public async System.Threading.Tasks.Task TestKeys()
      {
         ...
         SubstrateNET.NetApi.Generated.Model.sp_core.bounded.weak_bounded_vec.WeakBoundedVecT8 mockupValue = this.GetTestValue2();
         ...
         SubstrateNET.NetApi.Generated.Model.sp_core.bounded.weak_bounded_vec.WeakBoundedVecT8 rpcResult = await rpcClient.GetKeys();

         // Test that the expected mockup value matches the actual result from RPC service.
         Assert.AreEqual(mockupValue.Encode(), rpcResult.Encode());
      }
      public SubstrateNET.NetApi.Generated.Model.sp_core.bounded.weak_bounded_vec.WeakBoundedVecT8 GetTestValue6()
      {
         SubstrateNET.NetApi.Generated.Model.sp_core.bounded.weak_bounded_vec.WeakBoundedVecT8 result;
         result = new SubstrateNET.NetApi.Generated.Model.sp_core.bounded.weak_bounded_vec.WeakBoundedVecT8();
         result.Value = new Ajuna.NetApi.Model.Types.Base.BaseVec<SubstrateNET.NetApi.Generated.Model.sp_authority_discovery.app.Public>();
      ...
      public async System.Threading.Tasks.Task TestNextKeys()
      {
         ...
         // Construct new RPC client to test with.
         AuthorityDiscoveryControllerClient rpcClient = new AuthorityDiscoveryControllerClient(_httpClient, subscriptionClient);
         SubstrateNET.NetApi.Generated.Model.sp_core.bounded.weak_bounded_vec.WeakBoundedVecT8 mockupValue = this.GetTestValue6();
         ...
         SubstrateNET.NetApi.Generated.Model.sp_core.bounded.weak_bounded_vec.WeakBoundedVecT8 rpcResult = await rpcClient.GetNextKeys();
