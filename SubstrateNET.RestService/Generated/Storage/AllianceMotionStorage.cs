...
namespace SubstrateNET.RestService.Generated.Storage
{
    ...
    public interface IAllianceMotionStorage : IStorage
    {
        ...
        /// </summary>
        SubstrateNET.NetApi.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT43 GetProposals();
    ...
    public sealed class AllianceMotionStorage : IAllianceMotionStorage
    {
        ...
        /// </summary>
        private TypedStorage<SubstrateNET.NetApi.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT43> _proposalsTypedStorage;
        ...
        {
            this.ProposalsTypedStorage = new TypedStorage<SubstrateNET.NetApi.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT43>("AllianceMotion.Proposals", storageDataProvider, storageChangeDelegates);
            this.ProposalOfTypedStorage = new TypedMapStorage<SubstrateNET.NetApi.Generated.Model.kitchensink_runtime.EnumRuntimeCall>("AllianceMotion.ProposalOf", storageDataProvider, storageChangeDelegates);
            this.VotingTypedStorage = new TypedMapStorage<SubstrateNET.NetApi.Generated.Model.pallet_collective.Votes>("AllianceMotion.Voting", storageDataProvider, storageChangeDelegates);
            ...
            this.MembersTypedStorage = new TypedStorage<Ajuna.NetApi.Model.Types.Base.BaseVec<SubstrateNET.NetApi.Generated.Model.sp_core.crypto.AccountId32>>("AllianceMotion.Members", storageDataProvider, storageChangeDelegates);
            this.PrimeTypedStorage = new TypedStorage<SubstrateNET.NetApi.Generated.Model.sp_core.crypto.AccountId32>("AllianceMotion.Prime", storageDataProvider, storageChangeDelegates);
        }
        
        /// <summary>
        /// _proposalsTypedStorage property
        /// </summary>
        public TypedStorage<SubstrateNET.NetApi.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT43> ProposalsTypedStorage
        {
            get
            {
        ...
        ///  The hashes of the active proposals.
        /// </summary>
        public SubstrateNET.NetApi.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT43 GetProposals()
        {
