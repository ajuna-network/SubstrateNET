...
using SubstrateNET.RestService.Formatters;
...
namespace SubstrateNET.RestService
{
   ...
   public class Startup
   {
      ...
      public void ConfigureServices(IServiceCollection services)
      {
         ...
         services.AddSwaggerGen(c =>
         {
            ...
            c.SwaggerDoc("v1", new OpenApiInfo { Title = "SubstrateNET.RestService", Version = "v1" });
         });
      }
      ...
      public void Configure(IApplicationBuilder app, IWebHostEnvironment env, StorageSubscriptionHandler handler)
      {
         ...
         app.UseSwaggerUI(
             c =>
             {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "SubstrateNET.RestService v1");
             }
         );
