...
namespace SubstrateNET.NetApi.Generated.Storage
{
    ...
    public sealed class NominationPoolsStorage
    {
        ...
        public NominationPoolsStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("NominationPools", "PoolMembers"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(SubstrateNET.NetApi.Generated.Model.sp_core.crypto.AccountId32), typeof(SubstrateNET.NetApi.Generated.Model.pallet_nomination_pools.PoolMember)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("NominationPools", "BondedPools"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Ajuna.NetApi.Model.Types.Primitive.U32), typeof(SubstrateNET.NetApi.Generated.Model.pallet_nomination_pools.BondedPoolInner)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("NominationPools", "RewardPools"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Ajuna.NetApi.Model.Types.Primitive.U32), typeof(SubstrateNET.NetApi.Generated.Model.pallet_nomination_pools.RewardPool)));
        ...
        ///  Active members.
        /// </summary>
        public static string PoolMembersParams(SubstrateNET.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  Active members.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.pallet_nomination_pools.PoolMember> PoolMembers(SubstrateNET.NetApi.Generated.Model.sp_core.crypto.AccountId32 key, CancellationToken token)
        {
            string parameters = NominationPoolsStorage.PoolMembersParams(key);
            return await _client.GetStorageAsync<SubstrateNET.NetApi.Generated.Model.pallet_nomination_pools.PoolMember>(parameters, token);
        }
        ...
        ///  Storage for bonded pools.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.pallet_nomination_pools.BondedPoolInner> BondedPools(Ajuna.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = NominationPoolsStorage.BondedPoolsParams(key);
            return await _client.GetStorageAsync<SubstrateNET.NetApi.Generated.Model.pallet_nomination_pools.BondedPoolInner>(parameters, token);
        }
        ...
        ///  is claimed, the balance comes out fo the reward pool. Keyed by the bonded pools account.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.pallet_nomination_pools.RewardPool> RewardPools(Ajuna.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = NominationPoolsStorage.RewardPoolsParams(key);
            return await _client.GetStorageAsync<SubstrateNET.NetApi.Generated.Model.pallet_nomination_pools.RewardPool>(parameters, token);
        }
        ...
        ///  hence the name sub-pools. Keyed by the bonded pools account.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.pallet_nomination_pools.SubPools> SubPoolsStorage(Ajuna.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = NominationPoolsStorage.SubPoolsStorageParams(key);
            return await _client.GetStorageAsync<SubstrateNET.NetApi.Generated.Model.pallet_nomination_pools.SubPools>(parameters, token);
        }
        ...
        /// </summary>
        public static string ReversePoolIdLookupParams(SubstrateNET.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  accounts are deterministically derived from it.
        /// </summary>
        public async Task<Ajuna.NetApi.Model.Types.Primitive.U32> ReversePoolIdLookup(SubstrateNET.NetApi.Generated.Model.sp_core.crypto.AccountId32 key, CancellationToken token)
        {
    ...
    public sealed class NominationPoolsCalls
    {
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method BondExtra(SubstrateNET.NetApi.Generated.Model.pallet_nomination_pools.EnumBondExtra extra)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method Nominate(Ajuna.NetApi.Model.Types.Primitive.U32 pool_id, Ajuna.NetApi.Model.Types.Base.BaseVec<SubstrateNET.NetApi.Generated.Model.sp_core.crypto.AccountId32> validators)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(pool_id.Encode());
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method SetState(Ajuna.NetApi.Model.Types.Primitive.U32 pool_id, SubstrateNET.NetApi.Generated.Model.pallet_nomination_pools.EnumPoolState state)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(pool_id.Encode());
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method SetConfigs(SubstrateNET.NetApi.Generated.Model.pallet_nomination_pools.EnumConfigOp min_join_bond, SubstrateNET.NetApi.Generated.Model.pallet_nomination_pools.EnumConfigOp min_create_bond, SubstrateNET.NetApi.Generated.Model.pallet_nomination_pools.EnumConfigOp max_pools, SubstrateNET.NetApi.Generated.Model.pallet_nomination_pools.EnumConfigOp max_members, SubstrateNET.NetApi.Generated.Model.pallet_nomination_pools.EnumConfigOp max_members_per_pool)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method UpdateRoles(Ajuna.NetApi.Model.Types.Primitive.U32 pool_id, SubstrateNET.NetApi.Generated.Model.pallet_nomination_pools.EnumConfigOp new_root, SubstrateNET.NetApi.Generated.Model.pallet_nomination_pools.EnumConfigOp new_nominator, SubstrateNET.NetApi.Generated.Model.pallet_nomination_pools.EnumConfigOp new_state_toggler)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(pool_id.Encode());
