...
namespace SubstrateNET.NetApi.Generated.Storage
{
    ...
    public sealed class ContractsStorage
    {
        ...
        /// </summary>
        public static string PristineCodeParams(SubstrateNET.NetApi.Generated.Model.primitive_types.H256 key)
        {
        ...
        /// </summary>
        public static string CodeStorageParams(SubstrateNET.NetApi.Generated.Model.primitive_types.H256 key)
        {
        ...
        ///  A mapping between an original code hash and instrumented wasm code, ready for execution.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.pallet_contracts.wasm.PrefabWasmModule> CodeStorage(SubstrateNET.NetApi.Generated.Model.primitive_types.H256 key, CancellationToken token)
        {
            string parameters = ContractsStorage.CodeStorageParams(key);
            return await _client.GetStorageAsync<SubstrateNET.NetApi.Generated.Model.pallet_contracts.wasm.PrefabWasmModule>(parameters, token);
        }
        ...
        /// </summary>
        public static string OwnerInfoOfParams(SubstrateNET.NetApi.Generated.Model.primitive_types.H256 key)
        {
        ...
        ///  A mapping between an original code hash and its owner information.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.pallet_contracts.wasm.OwnerInfo> OwnerInfoOf(SubstrateNET.NetApi.Generated.Model.primitive_types.H256 key, CancellationToken token)
        {
            string parameters = ContractsStorage.OwnerInfoOfParams(key);
            return await _client.GetStorageAsync<SubstrateNET.NetApi.Generated.Model.pallet_contracts.wasm.OwnerInfo>(parameters, token);
        }
        ...
        /// </summary>
        public static string ContractInfoOfParams(SubstrateNET.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
        {
    ...
    public sealed class ContractsCalls
    {
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method RemoveCode(SubstrateNET.NetApi.Generated.Model.primitive_types.H256 code_hash)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(code_hash.Encode());
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method SetCode(SubstrateNET.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress dest, SubstrateNET.NetApi.Generated.Model.primitive_types.H256 code_hash)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(dest.Encode());
            byteArray.AddRange(code_hash.Encode());
