...
namespace SubstrateNET.NetApi.Generated.Storage
{
    ...
    public sealed class DemocracyStorage
    {
        ...
        public DemocracyStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Democracy", "ReferendumInfoOf"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Ajuna.NetApi.Model.Types.Primitive.U32), typeof(SubstrateNET.NetApi.Generated.Model.pallet_democracy.types.EnumReferendumInfo)));
        ...
        ///  TWOX-NOTE: SAFE as indexes are not under an attacker���s control.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.pallet_democracy.types.EnumReferendumInfo> ReferendumInfoOf(Ajuna.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = DemocracyStorage.ReferendumInfoOfParams(key);
            return await _client.GetStorageAsync<SubstrateNET.NetApi.Generated.Model.pallet_democracy.types.EnumReferendumInfo>(parameters, token);
        }
        ...
        /// </summary>
        public static string VotingOfParams(SubstrateNET.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  TWOX-NOTE: SAFE as `AccountId`s are crypto hashes anyway.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.pallet_democracy.vote.EnumVoting> VotingOf(SubstrateNET.NetApi.Generated.Model.sp_core.crypto.AccountId32 key, CancellationToken token)
        {
            string parameters = DemocracyStorage.VotingOfParams(key);
            return await _client.GetStorageAsync<SubstrateNET.NetApi.Generated.Model.pallet_democracy.vote.EnumVoting>(parameters, token);
        }
        ...
        /// </summary>
        public static string BlacklistParams(SubstrateNET.NetApi.Generated.Model.primitive_types.H256 key)
        {
        ...
        /// </summary>
        public static string CancellationsParams(SubstrateNET.NetApi.Generated.Model.primitive_types.H256 key)
        {
        ...
        ///  Record of all proposals that have been subject to emergency cancellation.
        /// </summary>
        public async Task<Ajuna.NetApi.Model.Types.Primitive.Bool> Cancellations(SubstrateNET.NetApi.Generated.Model.primitive_types.H256 key, CancellationToken token)
        {
    ...
    public sealed class DemocracyCalls
    {
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method Vote(Ajuna.NetApi.Model.Types.Base.BaseCom<Ajuna.NetApi.Model.Types.Primitive.U32> ref_index, SubstrateNET.NetApi.Generated.Model.pallet_democracy.vote.EnumAccountVote vote)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method FastTrack(SubstrateNET.NetApi.Generated.Model.primitive_types.H256 proposal_hash, Ajuna.NetApi.Model.Types.Primitive.U32 voting_period, Ajuna.NetApi.Model.Types.Primitive.U32 delay)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(proposal_hash.Encode());
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method VetoExternal(SubstrateNET.NetApi.Generated.Model.primitive_types.H256 proposal_hash)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(proposal_hash.Encode());
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method Blacklist(SubstrateNET.NetApi.Generated.Model.primitive_types.H256 proposal_hash, Ajuna.NetApi.Model.Types.Base.BaseOpt<Ajuna.NetApi.Model.Types.Primitive.U32> maybe_ref_index)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(proposal_hash.Encode());
