...
namespace SubstrateNET.NetApi.Generated.Storage
{
    ...
    public sealed class ElectionProviderMultiPhaseStorage
    {
        ...
        public ElectionProviderMultiPhaseStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ElectionProviderMultiPhase", "CurrentPhase"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(SubstrateNET.NetApi.Generated.Model.pallet_election_provider_multi_phase.EnumPhase)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ElectionProviderMultiPhase", "QueuedSolution"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(SubstrateNET.NetApi.Generated.Model.pallet_election_provider_multi_phase.ReadySolution)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ElectionProviderMultiPhase", "Snapshot"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(SubstrateNET.NetApi.Generated.Model.pallet_election_provider_multi_phase.RoundSnapshot)));
        ...
        ///  Current phase.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.pallet_election_provider_multi_phase.EnumPhase> CurrentPhase(CancellationToken token)
        {
            string parameters = ElectionProviderMultiPhaseStorage.CurrentPhaseParams();
            return await _client.GetStorageAsync<SubstrateNET.NetApi.Generated.Model.pallet_election_provider_multi_phase.EnumPhase>(parameters, token);
        }
        ...
        ///  Current best solution, signed or unsigned, queued to be returned upon `elect`.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.pallet_election_provider_multi_phase.ReadySolution> QueuedSolution(CancellationToken token)
        {
            string parameters = ElectionProviderMultiPhaseStorage.QueuedSolutionParams();
            return await _client.GetStorageAsync<SubstrateNET.NetApi.Generated.Model.pallet_election_provider_multi_phase.ReadySolution>(parameters, token);
        }
        ...
        ///  This is created at the beginning of the signed phase and cleared upon calling `elect`.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.pallet_election_provider_multi_phase.RoundSnapshot> Snapshot(CancellationToken token)
        {
            string parameters = ElectionProviderMultiPhaseStorage.SnapshotParams();
            return await _client.GetStorageAsync<SubstrateNET.NetApi.Generated.Model.pallet_election_provider_multi_phase.RoundSnapshot>(parameters, token);
        }
        ...
        ///  Only exists when [`Snapshot`] is present.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.pallet_election_provider_multi_phase.SolutionOrSnapshotSize> SnapshotMetadata(CancellationToken token)
        {
            string parameters = ElectionProviderMultiPhaseStorage.SnapshotMetadataParams();
            return await _client.GetStorageAsync<SubstrateNET.NetApi.Generated.Model.pallet_election_provider_multi_phase.SolutionOrSnapshotSize>(parameters, token);
        }
        ...
        ///  affect; we shouldn't need a cryptographically secure hasher.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.pallet_election_provider_multi_phase.signed.SignedSubmission> SignedSubmissionsMap(Ajuna.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = ElectionProviderMultiPhaseStorage.SignedSubmissionsMapParams(key);
            return await _client.GetStorageAsync<SubstrateNET.NetApi.Generated.Model.pallet_election_provider_multi_phase.signed.SignedSubmission>(parameters, token);
        }
        ...
        ///  Can be set via `set_minimum_untrusted_score`.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.sp_npos_elections.ElectionScore> MinimumUntrustedScore(CancellationToken token)
        {
            string parameters = ElectionProviderMultiPhaseStorage.MinimumUntrustedScoreParams();
            return await _client.GetStorageAsync<SubstrateNET.NetApi.Generated.Model.sp_npos_elections.ElectionScore>(parameters, token);
        }
    }
    ...
    public sealed class ElectionProviderMultiPhaseCalls
    {
        ...
        /// </summary>
        public static Method SubmitUnsigned(SubstrateNET.NetApi.Generated.Model.pallet_election_provider_multi_phase.RawSolution raw_solution, SubstrateNET.NetApi.Generated.Model.pallet_election_provider_multi_phase.SolutionOrSnapshotSize witness)
        {
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method SetMinimumUntrustedScore(Ajuna.NetApi.Model.Types.Base.BaseOpt<SubstrateNET.NetApi.Generated.Model.sp_npos_elections.ElectionScore> maybe_next_score)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method SetEmergencyElectionResult(Ajuna.NetApi.Model.Types.Base.BaseVec<Ajuna.NetApi.Model.Types.Base.BaseTuple<SubstrateNET.NetApi.Generated.Model.sp_core.crypto.AccountId32, SubstrateNET.NetApi.Generated.Model.sp_npos_elections.Support>> supports)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method Submit(SubstrateNET.NetApi.Generated.Model.pallet_election_provider_multi_phase.RawSolution raw_solution)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(raw_solution.Encode());
