...
namespace SubstrateNET.NetApi.Generated.Storage
{
    ...
    public sealed class LotteryStorage
    {
        ...
        ///  The configuration for the current lottery.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.pallet_lottery.LotteryConfig> Lottery(CancellationToken token)
        {
            string parameters = LotteryStorage.LotteryParams();
            return await _client.GetStorageAsync<SubstrateNET.NetApi.Generated.Model.pallet_lottery.LotteryConfig>(parameters, token);
        }
        ...
        /// </summary>
        public static string ParticipantsParams(SubstrateNET.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  are actually valid ticket mappings.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.sp_core.crypto.AccountId32> Tickets(Ajuna.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
