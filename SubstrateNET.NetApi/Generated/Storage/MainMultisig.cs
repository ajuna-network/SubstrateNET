...
namespace SubstrateNET.NetApi.Generated.Storage
{
    ...
    public sealed class MultisigStorage
    {
        ...
        /// </summary>
        public static string MultisigsParams(Ajuna.NetApi.Model.Types.Base.BaseTuple<SubstrateNET.NetApi.Generated.Model.sp_core.crypto.AccountId32, SubstrateNET.NetApi.Generated.Types.Base.Arr32U8> key)
        {
        ...
        ///  The set of open multisig operations.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.pallet_multisig.Multisig> Multisigs(Ajuna.NetApi.Model.Types.Base.BaseTuple<SubstrateNET.NetApi.Generated.Model.sp_core.crypto.AccountId32, SubstrateNET.NetApi.Generated.Types.Base.Arr32U8> key, CancellationToken token)
        {
    ...
    public sealed class MultisigCalls
    {
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method CancelAsMulti(Ajuna.NetApi.Model.Types.Primitive.U16 threshold, Ajuna.NetApi.Model.Types.Base.BaseVec<SubstrateNET.NetApi.Generated.Model.sp_core.crypto.AccountId32> other_signatories, SubstrateNET.NetApi.Generated.Model.pallet_multisig.Timepoint timepoint, SubstrateNET.NetApi.Generated.Types.Base.Arr32U8 call_hash)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(threshold.Encode());
            byteArray.AddRange(other_signatories.Encode());
