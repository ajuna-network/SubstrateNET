...
namespace SubstrateNET.NetApi.Generated.Storage
{
    ...
    public sealed class AllianceMotionStorage
    {
        ...
        public AllianceMotionStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("AllianceMotion", "Members"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Ajuna.NetApi.Model.Types.Base.BaseVec<SubstrateNET.NetApi.Generated.Model.sp_core.crypto.AccountId32>)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("AllianceMotion", "Prime"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(SubstrateNET.NetApi.Generated.Model.sp_core.crypto.AccountId32)));
        }
        ...
        /// </summary>
        public static string ProposalOfParams(SubstrateNET.NetApi.Generated.Model.primitive_types.H256 key)
        {
        ...
        /// </summary>
        public static string VotingParams(SubstrateNET.NetApi.Generated.Model.primitive_types.H256 key)
        {
        ...
        ///  Votes on a given proposal, if it is ongoing.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.pallet_collective.Votes> Voting(SubstrateNET.NetApi.Generated.Model.primitive_types.H256 key, CancellationToken token)
        {
            string parameters = AllianceMotionStorage.VotingParams(key);
            return await _client.GetStorageAsync<SubstrateNET.NetApi.Generated.Model.pallet_collective.Votes>(parameters, token);
        }
        ...
        ///  The prime member that helps determine the default vote behavior in case of absentations.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.sp_core.crypto.AccountId32> Prime(CancellationToken token)
        {
    ...
    public sealed class AllianceMotionCalls
    {
        ...
        /// </summary>
        public static Method SetMembers(Ajuna.NetApi.Model.Types.Base.BaseVec<SubstrateNET.NetApi.Generated.Model.sp_core.crypto.AccountId32> new_members, Ajuna.NetApi.Model.Types.Base.BaseOpt<SubstrateNET.NetApi.Generated.Model.sp_core.crypto.AccountId32> prime, Ajuna.NetApi.Model.Types.Primitive.U32 old_count)
        {
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method DisapproveProposal(SubstrateNET.NetApi.Generated.Model.primitive_types.H256 proposal_hash)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(proposal_hash.Encode());
