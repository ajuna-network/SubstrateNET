    ...
    public sealed class RankedCollectiveStorage
    {
        ...
        public RankedCollectiveStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("RankedCollective", "Members"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(SubstrateNET.NetApi.Generated.Model.sp_core.crypto.AccountId32), typeof(SubstrateNET.NetApi.Generated.Model.pallet_ranked_collective.MemberRecord)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("RankedCollective", "IdToIndex"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            ...
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.NetApi.Model.Types.Primitive.U16, SubstrateNET.NetApi.Generated.Model.sp_core.crypto.AccountId32>), typeof(Ajuna.NetApi.Model.Types.Primitive.U32)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("RankedCollective", "IndexToId"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Twox64Concat,
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.NetApi.Model.Types.Primitive.U16, Ajuna.NetApi.Model.Types.Primitive.U32>), typeof(SubstrateNET.NetApi.Generated.Model.sp_core.crypto.AccountId32)));
        ...
        /// </summary>
        public static string MembersParams(SubstrateNET.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  The current members of the collective.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.pallet_ranked_collective.MemberRecord> Members(SubstrateNET.NetApi.Generated.Model.sp_core.crypto.AccountId32 key, CancellationToken token)
        {
            string parameters = RankedCollectiveStorage.MembersParams(key);
            return await _client.GetStorageAsync<SubstrateNET.NetApi.Generated.Model.pallet_ranked_collective.MemberRecord>(parameters, token);
        }
        ...
        /// </summary>
        public static string IdToIndexParams(Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.NetApi.Model.Types.Primitive.U16, SubstrateNET.NetApi.Generated.Model.sp_core.crypto.AccountId32> key)
        {
        ...
        ///  The index of each ranks's member into the group of members who have at least that rank.
        /// </summary>
        public async Task<Ajuna.NetApi.Model.Types.Primitive.U32> IdToIndex(Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.NetApi.Model.Types.Primitive.U16, SubstrateNET.NetApi.Generated.Model.sp_core.crypto.AccountId32> key, CancellationToken token)
        {
        ...
        ///  return `Some`, however a member's index is not guaranteed to remain unchanged over time.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.sp_core.crypto.AccountId32> IndexToId(Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.NetApi.Model.Types.Primitive.U16, Ajuna.NetApi.Model.Types.Primitive.U32> key, CancellationToken token)
        {
        ...
        /// </summary>
        public static string VotingParams(Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.NetApi.Model.Types.Primitive.U32, SubstrateNET.NetApi.Generated.Model.sp_core.crypto.AccountId32> key)
        {
        ...
        ///  Votes on a given proposal, if it is ongoing.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.pallet_ranked_collective.EnumVoteRecord> Voting(Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.NetApi.Model.Types.Primitive.U32, SubstrateNET.NetApi.Generated.Model.sp_core.crypto.AccountId32> key, CancellationToken token)
        {
            string parameters = RankedCollectiveStorage.VotingParams(key);
            return await _client.GetStorageAsync<SubstrateNET.NetApi.Generated.Model.pallet_ranked_collective.EnumVoteRecord>(parameters, token);
        }
