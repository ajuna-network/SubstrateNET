...
namespace SubstrateNET.NetApi.Generated.Storage
{
    ...
    public sealed class GrandpaStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Grandpa", "State"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(SubstrateNET.NetApi.Generated.Model.pallet_grandpa.EnumStoredState)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Grandpa", "PendingChange"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(SubstrateNET.NetApi.Generated.Model.pallet_grandpa.StoredPendingChange)));
        ...
        ///  State of the current authority set.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.pallet_grandpa.EnumStoredState> State(CancellationToken token)
        {
            string parameters = GrandpaStorage.StateParams();
            return await _client.GetStorageAsync<SubstrateNET.NetApi.Generated.Model.pallet_grandpa.EnumStoredState>(parameters, token);
        }
        ...
        ///  Pending change: (signaled at, scheduled change).
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.pallet_grandpa.StoredPendingChange> PendingChange(CancellationToken token)
        {
            string parameters = GrandpaStorage.PendingChangeParams();
            return await _client.GetStorageAsync<SubstrateNET.NetApi.Generated.Model.pallet_grandpa.StoredPendingChange>(parameters, token);
        }
    ...
    public sealed class GrandpaCalls
    {
        ...
        /// </summary>
        public static Method ReportEquivocation(SubstrateNET.NetApi.Generated.Model.sp_finality_grandpa.EquivocationProof equivocation_proof, SubstrateNET.NetApi.Generated.Model.sp_session.MembershipProof key_owner_proof)
        {
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method ReportEquivocationUnsigned(SubstrateNET.NetApi.Generated.Model.sp_finality_grandpa.EquivocationProof equivocation_proof, SubstrateNET.NetApi.Generated.Model.sp_session.MembershipProof key_owner_proof)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(equivocation_proof.Encode());
            byteArray.AddRange(key_owner_proof.Encode());
