...
namespace SubstrateNET.NetApi.Generated.Storage
{
    ...
    public sealed class RankedPollsStorage
    {
        ...
        ///  Information concerning any given referendum.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.pallet_referenda.types.EnumReferendumInfo> ReferendumInfoFor(Ajuna.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = RankedPollsStorage.ReferendumInfoForParams(key);
            return await _client.GetStorageAsync<SubstrateNET.NetApi.Generated.Model.pallet_referenda.types.EnumReferendumInfo>(parameters, token);
        }
