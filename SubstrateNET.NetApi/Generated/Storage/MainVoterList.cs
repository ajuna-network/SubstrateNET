...
namespace SubstrateNET.NetApi.Generated.Storage
{
    ...
    public sealed class VoterListStorage
    {
        ...
        public VoterListStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("VoterList", "ListNodes"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(SubstrateNET.NetApi.Generated.Model.sp_core.crypto.AccountId32), typeof(SubstrateNET.NetApi.Generated.Model.pallet_bags_list.list.Node)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("VoterList", "ListBags"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Ajuna.NetApi.Model.Types.Primitive.U64), typeof(SubstrateNET.NetApi.Generated.Model.pallet_bags_list.list.Bag)));
        }
        ...
        /// </summary>
        public static string ListNodesParams(SubstrateNET.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  Nodes store links forward and back within their respective bags.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.pallet_bags_list.list.Node> ListNodes(SubstrateNET.NetApi.Generated.Model.sp_core.crypto.AccountId32 key, CancellationToken token)
        {
            string parameters = VoterListStorage.ListNodesParams(key);
            return await _client.GetStorageAsync<SubstrateNET.NetApi.Generated.Model.pallet_bags_list.list.Node>(parameters, token);
        }
        ...
        ///  Stores a `Bag` struct, which stores head and tail pointers to itself.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.pallet_bags_list.list.Bag> ListBags(Ajuna.NetApi.Model.Types.Primitive.U64 key, CancellationToken token)
        {
            string parameters = VoterListStorage.ListBagsParams(key);
            return await _client.GetStorageAsync<SubstrateNET.NetApi.Generated.Model.pallet_bags_list.list.Bag>(parameters, token);
        }
    }
    ...
    public sealed class VoterListCalls
    {
        ...
        /// </summary>
        public static Method Rebag(SubstrateNET.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress dislocated)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(dislocated.Encode());
            return new Method(42, "VoterList", 0, "rebag", byteArray.ToArray());
        }
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method PutInFrontOf(SubstrateNET.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress lighter)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(lighter.Encode());
            return new Method(42, "VoterList", 1, "put_in_front_of", byteArray.ToArray());
        }
    }
