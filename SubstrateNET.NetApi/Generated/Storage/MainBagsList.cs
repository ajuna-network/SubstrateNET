...
namespace SubstrateNET.NetApi.Generated.Storage
{
    ...
    public sealed class BagsListCalls
    {
        ...
        /// </summary>
        public static Method Rebag(SubstrateNET.NetApi.Generated.Model.sp_core.crypto.AccountId32 dislocated)
        {
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method PutInFrontOf(SubstrateNET.NetApi.Generated.Model.sp_core.crypto.AccountId32 lighter)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
