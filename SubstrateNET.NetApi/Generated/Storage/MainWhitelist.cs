...
namespace SubstrateNET.NetApi.Generated.Storage
{
    ...
    public sealed class WhitelistStorage
    {
        ...
        public WhitelistStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Whitelist", "WhitelistedCall"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(SubstrateNET.NetApi.Generated.Model.primitive_types.H256), typeof(Ajuna.NetApi.Model.Types.Base.BaseTuple)));
        }
        
        /// <summary>
        /// >> WhitelistedCallParams
        /// </summary>
        public static string WhitelistedCallParams(SubstrateNET.NetApi.Generated.Model.primitive_types.H256 key)
        {
        ...
        /// >> WhitelistedCall
        /// </summary>
        public async Task<Ajuna.NetApi.Model.Types.Base.BaseTuple> WhitelistedCall(SubstrateNET.NetApi.Generated.Model.primitive_types.H256 key, CancellationToken token)
        {
    ...
    public sealed class WhitelistCalls
    {
        ...
        /// </summary>
        public static Method WhitelistCall(SubstrateNET.NetApi.Generated.Model.primitive_types.H256 call_hash)
        {
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method RemoveWhitelistedCall(SubstrateNET.NetApi.Generated.Model.primitive_types.H256 call_hash)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(call_hash.Encode());
