...
namespace SubstrateNET.NetApi.Generated.Storage
{
    ...
    public sealed class PreimageStorage
    {
        ...
        /// </summary>
        public static string StatusForParams(SubstrateNET.NetApi.Generated.Model.primitive_types.H256 key)
        {
        ...
        ///  The request status of a given hash.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.pallet_preimage.EnumRequestStatus> StatusFor(SubstrateNET.NetApi.Generated.Model.primitive_types.H256 key, CancellationToken token)
        {
            string parameters = PreimageStorage.StatusForParams(key);
            return await _client.GetStorageAsync<SubstrateNET.NetApi.Generated.Model.pallet_preimage.EnumRequestStatus>(parameters, token);
        }
    ...
    public sealed class PreimageCalls
    {
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method UnnotePreimage(SubstrateNET.NetApi.Generated.Model.primitive_types.H256 hash)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method RequestPreimage(SubstrateNET.NetApi.Generated.Model.primitive_types.H256 hash)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(hash.Encode());
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method UnrequestPreimage(SubstrateNET.NetApi.Generated.Model.primitive_types.H256 hash)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(hash.Encode());
