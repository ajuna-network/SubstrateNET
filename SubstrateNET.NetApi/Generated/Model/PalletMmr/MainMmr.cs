...
namespace SubstrateNET.NetApi.Generated.Model.PalletMmr
{
    ...
    public sealed class MmrStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Mmr", "RootHash"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(SubstrateNET.NetApi.Generated.Model.PrimitiveTypes.H256)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Mmr", "Nodes"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Identity}, typeof(Ajuna.NetApi.Model.Types.Primitive.U64), typeof(SubstrateNET.NetApi.Generated.Model.PrimitiveTypes.H256)));
        }
        ...
        ///  Latest MMR Root hash.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.PrimitiveTypes.H256> RootHash(CancellationToken token)
        {
        ...
        ///  are pruned and only stored in the Offchain DB.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.PrimitiveTypes.H256> Nodes(Ajuna.NetApi.Model.Types.Primitive.U64 key, CancellationToken token)
        {
