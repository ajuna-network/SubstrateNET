...
namespace SubstrateNET.NetApi.Generated.Model.PalletBabe
{
    ...
    public sealed class BabeStorage
    {
        ...
        public BabeStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Babe", "EpochConfig"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(SubstrateNET.NetApi.Generated.Model.SpConsensusBabe.BabeEpochConfiguration)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Babe", "NextEpochConfig"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(SubstrateNET.NetApi.Generated.Model.SpConsensusBabe.BabeEpochConfiguration)));
        }
        ...
        ///  until the first block of the chain.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.SpConsensusSlots.Slot> GenesisSlot(CancellationToken token)
        {
            string parameters = BabeStorage.GenesisSlotParams();
            return await _client.GetStorageAsync<SubstrateNET.NetApi.Generated.Model.SpConsensusSlots.Slot>(parameters, token);
        }
        ...
        ///  Current slot number.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.SpConsensusSlots.Slot> CurrentSlot(CancellationToken token)
        {
        ...
        ///  adversary, for purposes such as public-coin zero-knowledge proofs.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.Base.Arr32U8> Randomness(CancellationToken token)
        {
            string parameters = BabeStorage.RandomnessParams();
            return await _client.GetStorageAsync<SubstrateNET.NetApi.Generated.Model.Base.Arr32U8>(parameters, token);
        }
        ...
        ///  Pending epoch configuration change that will be applied when the next epoch is enacted.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.SpConsensusBabe.EnumNextConfigDescriptor> PendingEpochConfigChange(CancellationToken token)
        {
            string parameters = BabeStorage.PendingEpochConfigChangeParams();
            return await _client.GetStorageAsync<SubstrateNET.NetApi.Generated.Model.SpConsensusBabe.EnumNextConfigDescriptor>(parameters, token);
        }
        ...
        ///  Next epoch randomness.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.Base.Arr32U8> NextRandomness(CancellationToken token)
        {
        ...
        ///  genesis.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.SpConsensusBabe.BabeEpochConfiguration> EpochConfig(CancellationToken token)
        {
            string parameters = BabeStorage.EpochConfigParams();
            return await _client.GetStorageAsync<SubstrateNET.NetApi.Generated.Model.SpConsensusBabe.BabeEpochConfiguration>(parameters, token);
        }
        ...
        ///  (you can fallback to `EpochConfig` instead in that case).
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.SpConsensusBabe.BabeEpochConfiguration> NextEpochConfig(CancellationToken token)
        {
    ...
    public sealed class BabeCalls
    {
        ...
        /// </summary>
        public static Method ReportEquivocation(SubstrateNET.NetApi.Generated.Model.SpConsensusSlots.EquivocationProof equivocation_proof, SubstrateNET.NetApi.Generated.Model.SpSession.MembershipProof key_owner_proof)
        {
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method ReportEquivocationUnsigned(SubstrateNET.NetApi.Generated.Model.SpConsensusSlots.EquivocationProof equivocation_proof, SubstrateNET.NetApi.Generated.Model.SpSession.MembershipProof key_owner_proof)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(equivocation_proof.Encode());
            byteArray.AddRange(key_owner_proof.Encode());
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method PlanConfigChange(SubstrateNET.NetApi.Generated.Model.SpConsensusBabe.EnumNextConfigDescriptor config)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
