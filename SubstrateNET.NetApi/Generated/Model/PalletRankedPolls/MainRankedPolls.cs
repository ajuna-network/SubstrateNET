...
namespace SubstrateNET.NetApi.Generated.Model.PalletRankedPolls
{
    
    
    public sealed class RankedPollsStorage
    {
        
        // Substrate client for the storage calls.
        private SubstrateClientExt _client;
        
        public RankedPollsStorage(SubstrateClientExt client)
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("RankedPolls", "ReferendumCount"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Ajuna.NetApi.Model.Types.Primitive.U32)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("RankedPolls", "TrackQueue"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Ajuna.NetApi.Model.Types.Primitive.U16), typeof(SubstrateNET.NetApi.Generated.Model.SpRuntime.BoundedVecT44)));
        ...
        {
            return RequestGenerator.GetStorage("RankedPolls", "ReferendumCount", Ajuna.NetApi.Model.Meta.Storage.Type.Plain);
        }
        ...
        {
            string parameters = RankedPollsStorage.ReferendumCountParams();
        ...
        {
            return RequestGenerator.GetStorage("RankedPolls", "ReferendumInfoFor", Ajuna.NetApi.Model.Meta.Storage.Type.Map, new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
        ...
        {
            string parameters = RankedPollsStorage.ReferendumInfoForParams(key);
        ...
        {
            return RequestGenerator.GetStorage("RankedPolls", "TrackQueue", Ajuna.NetApi.Model.Meta.Storage.Type.Map, new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
        ...
        ///  This should be empty if `DecidingCount` is less than `TrackInfo::max_deciding`.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.SpRuntime.BoundedVecT44> TrackQueue(Ajuna.NetApi.Model.Types.Primitive.U16 key, CancellationToken token)
        {
            string parameters = RankedPollsStorage.TrackQueueParams(key);
            return await _client.GetStorageAsync<SubstrateNET.NetApi.Generated.Model.SpRuntime.BoundedVecT44>(parameters, token);
        }
        ...
        {
            return RequestGenerator.GetStorage("RankedPolls", "DecidingCount", Ajuna.NetApi.Model.Meta.Storage.Type.Map, new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                        Ajuna.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, new Ajuna.NetApi.Model.Types.IType[] {
                        key});
        }
        ...
        {
            string parameters = RankedPollsStorage.DecidingCountParams(key);
            return await _client.GetStorageAsync<Ajuna.NetApi.Model.Types.Primitive.U32>(parameters, token);
        }
    }
    
    public sealed class RankedPollsCalls
    {
        ...
        public static Method PlaceDecisionDeposit(Ajuna.NetApi.Model.Types.Primitive.U32 index)
        {
            ...
            return new Method(52, "RankedPolls", 1, "place_decision_deposit", byteArray.ToArray());
        }
        ...
        public static Method RefundDecisionDeposit(Ajuna.NetApi.Model.Types.Primitive.U32 index)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(index.Encode());
            return new Method(52, "RankedPolls", 2, "refund_decision_deposit", byteArray.ToArray());
        }
        ...
        public static Method Cancel(Ajuna.NetApi.Model.Types.Primitive.U32 index)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(index.Encode());
            return new Method(52, "RankedPolls", 3, "cancel", byteArray.ToArray());
        }
        ...
        public static Method Kill(Ajuna.NetApi.Model.Types.Primitive.U32 index)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(index.Encode());
            return new Method(52, "RankedPolls", 4, "kill", byteArray.ToArray());
        }
        ...
        public static Method NudgeReferendum(Ajuna.NetApi.Model.Types.Primitive.U32 index)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(index.Encode());
            return new Method(52, "RankedPolls", 5, "nudge_referendum", byteArray.ToArray());
        }
        ...
        public static Method OneFewerDeciding(Ajuna.NetApi.Model.Types.Primitive.U16 track)
        {
            ...
            return new Method(52, "RankedPolls", 6, "one_fewer_deciding", byteArray.ToArray());
        }
    }
    
    public enum RankedPollsErrors
    {
