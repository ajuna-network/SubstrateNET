...
namespace SubstrateNET.NetApi.Generated.Model.PalletElectionProviderMultiPhase
{
    ...
    public sealed class ElectionProviderMultiPhaseStorage
    {
        ...
        public ElectionProviderMultiPhaseStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ElectionProviderMultiPhase", "SignedSubmissionIndices"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(SubstrateNET.NetApi.Generated.Model.FrameSupport.BoundedBTreeMap)));
        ...
        ///  them one at a time instead of reading and decoding all of them at once.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.FrameSupport.BoundedBTreeMap> SignedSubmissionIndices(CancellationToken token)
        {
            string parameters = ElectionProviderMultiPhaseStorage.SignedSubmissionIndicesParams();
            return await _client.GetStorageAsync<SubstrateNET.NetApi.Generated.Model.FrameSupport.BoundedBTreeMap>(parameters, token);
        }
