...
namespace SubstrateNET.NetApi.Generated.Model.PalletGilt
{
    ...
    public sealed class GiltStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Gilt", "QueueTotals"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(SubstrateNET.NetApi.Generated.Model.FrameSupport.BoundedVecT23)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Gilt", "Queues"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Ajuna.NetApi.Model.Types.Primitive.U32), typeof(SubstrateNET.NetApi.Generated.Model.FrameSupport.BoundedVecT24)));
        ...
        ///  whose duration is one `Period` would be storage `0`.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.FrameSupport.BoundedVecT23> QueueTotals(CancellationToken token)
        {
            string parameters = GiltStorage.QueueTotalsParams();
            return await _client.GetStorageAsync<SubstrateNET.NetApi.Generated.Model.FrameSupport.BoundedVecT23>(parameters, token);
        }
        ...
        ///  The queues of bids ready to become gilts. Indexed by duration (in `Period`s).
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.FrameSupport.BoundedVecT24> Queues(Ajuna.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = GiltStorage.QueuesParams(key);
            return await _client.GetStorageAsync<SubstrateNET.NetApi.Generated.Model.FrameSupport.BoundedVecT24>(parameters, token);
        }
        ...
        ///  Information relating to the gilts currently active.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.PalletGilt.ActiveGiltsTotal> ActiveTotal(CancellationToken token)
        {
            string parameters = GiltStorage.ActiveTotalParams();
            return await _client.GetStorageAsync<SubstrateNET.NetApi.Generated.Model.PalletGilt.ActiveGiltsTotal>(parameters, token);
        }
        ...
        ///  The currently active gilts, indexed according to the order of creation.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.PalletGilt.ActiveGilt> Active(Ajuna.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = GiltStorage.ActiveParams(key);
            return await _client.GetStorageAsync<SubstrateNET.NetApi.Generated.Model.PalletGilt.ActiveGilt>(parameters, token);
        }
    }
    ...
    public sealed class GiltCalls
    {
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method SetTarget(BaseCom<SubstrateNET.NetApi.Generated.Model.SpArithmetic.Perquintill> target)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
