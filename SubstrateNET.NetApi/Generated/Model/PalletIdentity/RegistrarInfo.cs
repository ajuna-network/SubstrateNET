...
namespace SubstrateNET.NetApi.Generated.Model.PalletIdentity
{
    ...
    /// <summary>
    /// >> 515 - Composite[pallet_identity.types.RegistrarInfo]
    /// </summary>
    ...
    public sealed class RegistrarInfo : BaseType
    {
        ...
        /// >> account
        /// </summary>
        private SubstrateNET.NetApi.Generated.Model.SpCore.AccountId32 _account;
        ...
        /// >> fields
        /// </summary>
        private SubstrateNET.NetApi.Generated.Model.PalletIdentity.BitFlags _fields;
        
        public SubstrateNET.NetApi.Generated.Model.SpCore.AccountId32 Account
        {
            get
            {
        ...
        public SubstrateNET.NetApi.Generated.Model.PalletIdentity.BitFlags Fields
        {
            get
            {
                return this._fields;
        ...
        {
            var start = p;
            Account = new SubstrateNET.NetApi.Generated.Model.SpCore.AccountId32();
            Account.Decode(byteArray, ref p);
            Fee = new Ajuna.NetApi.Model.Types.Primitive.U128();
            Fee.Decode(byteArray, ref p);
            Fields = new SubstrateNET.NetApi.Generated.Model.PalletIdentity.BitFlags();
