...
namespace SubstrateNET.NetApi.Generated.Model.PalletGrandpa
{
    ...
    public sealed class GrandpaStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Grandpa", "State"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(SubstrateNET.NetApi.Generated.Model.PalletGrandpa.EnumStoredState)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Grandpa", "PendingChange"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(SubstrateNET.NetApi.Generated.Model.PalletGrandpa.StoredPendingChange)));
        ...
        ///  State of the current authority set.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.PalletGrandpa.EnumStoredState> State(CancellationToken token)
        {
            string parameters = GrandpaStorage.StateParams();
            return await _client.GetStorageAsync<SubstrateNET.NetApi.Generated.Model.PalletGrandpa.EnumStoredState>(parameters, token);
        }
        ...
        ///  Pending change: (signaled at, scheduled change).
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.PalletGrandpa.StoredPendingChange> PendingChange(CancellationToken token)
        {
            string parameters = GrandpaStorage.PendingChangeParams();
            return await _client.GetStorageAsync<SubstrateNET.NetApi.Generated.Model.PalletGrandpa.StoredPendingChange>(parameters, token);
        }
    ...
    public sealed class GrandpaCalls
    {
        ...
        /// </summary>
        public static Method ReportEquivocation(SubstrateNET.NetApi.Generated.Model.SpFinalityGrandpa.EquivocationProof equivocation_proof, SubstrateNET.NetApi.Generated.Model.SpSession.MembershipProof key_owner_proof)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(equivocation_proof.Encode());
            byteArray.AddRange(key_owner_proof.Encode());
            return new Method(17, "Grandpa", 0, "report_equivocation", byteArray.ToArray());
        }
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method ReportEquivocationUnsigned(SubstrateNET.NetApi.Generated.Model.SpFinalityGrandpa.EquivocationProof equivocation_proof, SubstrateNET.NetApi.Generated.Model.SpSession.MembershipProof key_owner_proof)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(equivocation_proof.Encode());
            byteArray.AddRange(key_owner_proof.Encode());
            return new Method(17, "Grandpa", 1, "report_equivocation_unsigned", byteArray.ToArray());
        }
        ...
        public static Method NoteStalled(Ajuna.NetApi.Model.Types.Primitive.U32 delay, Ajuna.NetApi.Model.Types.Primitive.U32 best_finalized_block_number)
        {
            ...
            return new Method(17, "Grandpa", 2, "note_stalled", byteArray.ToArray());
        }
    }
