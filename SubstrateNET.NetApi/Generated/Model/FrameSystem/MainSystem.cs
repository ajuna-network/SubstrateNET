...
namespace SubstrateNET.NetApi.Generated.Model.FrameSystem
{
    ...
    public sealed class SystemStorage
    {
        ...
        public SystemStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("System", "Account"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(SubstrateNET.NetApi.Generated.Model.SpCore.AccountId32), typeof(SubstrateNET.NetApi.Generated.Model.FrameSystem.AccountInfo)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("System", "BlockWeight"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(SubstrateNET.NetApi.Generated.Model.FrameSupport.PerDispatchClassT1)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("System", "BlockHash"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Ajuna.NetApi.Model.Types.Primitive.U32), typeof(SubstrateNET.NetApi.Generated.Model.PrimitiveTypes.H256)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("System", "ParentHash"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(SubstrateNET.NetApi.Generated.Model.PrimitiveTypes.H256)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("System", "Digest"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(SubstrateNET.NetApi.Generated.Model.SpRuntime.Digest)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("System", "Events"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(BaseVec<SubstrateNET.NetApi.Generated.Model.FrameSystem.EventRecord>)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("System", "EventTopics"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(SubstrateNET.NetApi.Generated.Model.PrimitiveTypes.H256), typeof(BaseVec<BaseTuple<Ajuna.NetApi.Model.Types.Primitive.U32,Ajuna.NetApi.Model.Types.Primitive.U32>>)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("System", "LastRuntimeUpgrade"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(SubstrateNET.NetApi.Generated.Model.FrameSystem.LastRuntimeUpgradeInfo)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("System", "ExecutionPhase"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(SubstrateNET.NetApi.Generated.Model.FrameSystem.EnumPhase)));
        }
        ...
        ///  The full account information for a particular account ID.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.FrameSystem.AccountInfo> Account(SubstrateNET.NetApi.Generated.Model.SpCore.AccountId32 key, CancellationToken token)
        {
            string parameters = SystemStorage.AccountParams(key);
            return await _client.GetStorageAsync<SubstrateNET.NetApi.Generated.Model.FrameSystem.AccountInfo>(parameters, token);
        }
        ...
        ///  The current weight for the block.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.FrameSupport.PerDispatchClassT1> BlockWeight(CancellationToken token)
        {
            string parameters = SystemStorage.BlockWeightParams();
            return await _client.GetStorageAsync<SubstrateNET.NetApi.Generated.Model.FrameSupport.PerDispatchClassT1>(parameters, token);
        }
        ...
        ///  Map of block numbers to block hashes.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.PrimitiveTypes.H256> BlockHash(Ajuna.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
        ...
        ///  Hash of the previous block.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.PrimitiveTypes.H256> ParentHash(CancellationToken token)
        {
        ...
        ///  Digest of the current block, also part of the block header.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.SpRuntime.Digest> Digest(CancellationToken token)
        {
            string parameters = SystemStorage.DigestParams();
            return await _client.GetStorageAsync<SubstrateNET.NetApi.Generated.Model.SpRuntime.Digest>(parameters, token);
        }
        ...
        ///  just in case someone still reads them from within the runtime.
        /// </summary>
        public async Task<BaseVec<SubstrateNET.NetApi.Generated.Model.FrameSystem.EventRecord>> Events(CancellationToken token)
        {
            string parameters = SystemStorage.EventsParams();
            return await _client.GetStorageAsync<BaseVec<SubstrateNET.NetApi.Generated.Model.FrameSystem.EventRecord>>(parameters, token);
        }
        ...
        /// </summary>
        public static string EventTopicsParams(SubstrateNET.NetApi.Generated.Model.PrimitiveTypes.H256 key)
        {
        ...
        ///  no notification will be triggered thus the event might be lost.
        /// </summary>
        public async Task<BaseVec<BaseTuple<Ajuna.NetApi.Model.Types.Primitive.U32,Ajuna.NetApi.Model.Types.Primitive.U32>>> EventTopics(SubstrateNET.NetApi.Generated.Model.PrimitiveTypes.H256 key, CancellationToken token)
        {
        ...
        ///  Stores the `spec_version` and `spec_name` of when the last runtime upgrade happened.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.FrameSystem.LastRuntimeUpgradeInfo> LastRuntimeUpgrade(CancellationToken token)
        {
            string parameters = SystemStorage.LastRuntimeUpgradeParams();
            return await _client.GetStorageAsync<SubstrateNET.NetApi.Generated.Model.FrameSystem.LastRuntimeUpgradeInfo>(parameters, token);
        }
        ...
        ///  The execution phase of the block.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.FrameSystem.EnumPhase> ExecutionPhase(CancellationToken token)
        {
            string parameters = SystemStorage.ExecutionPhaseParams();
            return await _client.GetStorageAsync<SubstrateNET.NetApi.Generated.Model.FrameSystem.EnumPhase>(parameters, token);
        }
    }
    ...
    public sealed class SystemCalls
    {
        ...
        /// </summary>
        public static Method FillBlock(SubstrateNET.NetApi.Generated.Model.SpArithmetic.Perbill ratio)
        {
