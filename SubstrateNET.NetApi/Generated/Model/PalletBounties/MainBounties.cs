...
namespace SubstrateNET.NetApi.Generated.Model.PalletBounties
{
    ...
    public sealed class BountiesStorage
    {
        ...
        ///  Bounties that have been made.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.PalletBounties.Bounty> Bounties(Ajuna.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = BountiesStorage.BountiesParams(key);
            return await _client.GetStorageAsync<SubstrateNET.NetApi.Generated.Model.PalletBounties.Bounty>(parameters, token);
        }
        ...
        ///  The description of each bounty.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.FrameSupport.BoundedVecT21> BountyDescriptions(Ajuna.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
    ...
    public sealed class BountiesCalls
    {
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method ProposeCurator(BaseCom<Ajuna.NetApi.Model.Types.Primitive.U32> bounty_id, SubstrateNET.NetApi.Generated.Model.SpRuntime.EnumMultiAddress curator, BaseCom<Ajuna.NetApi.Model.Types.Primitive.U128> fee)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(bounty_id.Encode());
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method AwardBounty(BaseCom<Ajuna.NetApi.Model.Types.Primitive.U32> bounty_id, SubstrateNET.NetApi.Generated.Model.SpRuntime.EnumMultiAddress beneficiary)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(bounty_id.Encode());
