...
namespace SubstrateNET.NetApi.Generated.Model.PalletSession
{
    ...
    public sealed class SessionStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Session", "Validators"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(BaseVec<SubstrateNET.NetApi.Generated.Model.SpCore.AccountId32>)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Session", "QueuedKeys"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(BaseVec<BaseTuple<SubstrateNET.NetApi.Generated.Model.SpCore.AccountId32,SubstrateNET.NetApi.Generated.Model.NodeRuntime.SessionKeys>>)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Session", "NextKeys"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(SubstrateNET.NetApi.Generated.Model.SpCore.AccountId32), typeof(SubstrateNET.NetApi.Generated.Model.NodeRuntime.SessionKeys)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Session", "KeyOwner"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(BaseTuple<SubstrateNET.NetApi.Generated.Model.SpCore.KeyTypeId,BaseVec<Ajuna.NetApi.Model.Types.Primitive.U8>>), typeof(SubstrateNET.NetApi.Generated.Model.SpCore.AccountId32)));
        }
        ...
        ///  The current set of validators.
        /// </summary>
        public async Task<BaseVec<SubstrateNET.NetApi.Generated.Model.SpCore.AccountId32>> Validators(CancellationToken token)
        {
        ...
        ///  will be used to determine the validator's session keys.
        /// </summary>
        public async Task<BaseVec<BaseTuple<SubstrateNET.NetApi.Generated.Model.SpCore.AccountId32,SubstrateNET.NetApi.Generated.Model.NodeRuntime.SessionKeys>>> QueuedKeys(CancellationToken token)
        {
            string parameters = SessionStorage.QueuedKeysParams();
            return await _client.GetStorageAsync<BaseVec<BaseTuple<SubstrateNET.NetApi.Generated.Model.SpCore.AccountId32,SubstrateNET.NetApi.Generated.Model.NodeRuntime.SessionKeys>>>(parameters, token);
        }
        ...
        /// </summary>
        public static string NextKeysParams(SubstrateNET.NetApi.Generated.Model.SpCore.AccountId32 key)
        {
        ...
        ///  The next session keys for a validator.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.NodeRuntime.SessionKeys> NextKeys(SubstrateNET.NetApi.Generated.Model.SpCore.AccountId32 key, CancellationToken token)
        {
            string parameters = SessionStorage.NextKeysParams(key);
            return await _client.GetStorageAsync<SubstrateNET.NetApi.Generated.Model.NodeRuntime.SessionKeys>(parameters, token);
        }
        ...
        /// </summary>
        public static string KeyOwnerParams(BaseTuple<SubstrateNET.NetApi.Generated.Model.SpCore.KeyTypeId,BaseVec<Ajuna.NetApi.Model.Types.Primitive.U8>> key)
        {
        ...
        ///  The owner of a key. The key is the `KeyTypeId` + the encoded key.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.SpCore.AccountId32> KeyOwner(BaseTuple<SubstrateNET.NetApi.Generated.Model.SpCore.KeyTypeId,BaseVec<Ajuna.NetApi.Model.Types.Primitive.U8>> key, CancellationToken token)
        {
    ...
    public sealed class SessionCalls
    {
        ...
        /// </summary>
        public static Method SetKeys(SubstrateNET.NetApi.Generated.Model.NodeRuntime.SessionKeys keys, BaseVec<Ajuna.NetApi.Model.Types.Primitive.U8> proof)
        {
