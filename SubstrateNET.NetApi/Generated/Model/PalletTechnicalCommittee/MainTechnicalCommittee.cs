...
namespace SubstrateNET.NetApi.Generated.Model.PalletTechnicalCommittee
{
    ...
    public sealed class TechnicalCommitteeStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("TechnicalCommittee", "Proposals"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(SubstrateNET.NetApi.Generated.Model.SpRuntime.BoundedVecT14)));
        ...
        ///  The hashes of the active proposals.
        /// </summary>
        public async Task<SubstrateNET.NetApi.Generated.Model.SpRuntime.BoundedVecT14> Proposals(CancellationToken token)
        {
            string parameters = TechnicalCommitteeStorage.ProposalsParams();
            return await _client.GetStorageAsync<SubstrateNET.NetApi.Generated.Model.SpRuntime.BoundedVecT14>(parameters, token);
        }
